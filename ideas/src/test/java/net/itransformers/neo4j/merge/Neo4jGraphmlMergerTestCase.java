...
import net.itransformers.utils.graphmlmerge.MyGraphMLWriter;
...
//        }
    ...
    public void testMerge() throws IOException {
        ...
        File file = new File("ideas/src/test/java/net/itransformers/neo4j/merge/1.graphml");
    ...
    public void testMerge2() throws IOException {
        File file1 = new File("ideas/src/test/java/net/itransformers/neo4j/merge/1.graphml");
        File file2 = new File("ideas/src/test/java/net/itransformers/neo4j/merge/2.graphml");
        File file3 = new File("ideas/src/test/java/net/itransformers/neo4j/merge/3.graphml");
        Neo4jGraphmlMerger neo4jMerger = new Neo4jGraphmlMerger();
        Transaction tx = graphdb.beginTx();
    ...
    public void testVertexMerge() throws IOException {
        File file1 = new File("ideas/src/test/java/net/itransformers/neo4j/merge/1.graphml");
        File expectedFile = new File("ideas/src/test/java/net/itransformers/neo4j/merge/vertex_merge1.graphml");
        Neo4jGraphmlMerger neo4jMerger = new Neo4jGraphmlMerger();
        Transaction tx = graphdb.beginTx();
...
//    @Test
//    public void testFindNode2() throws IOException {
//        Transaction tx = graphdb.beginTx();
//        Node node =graphdb.createNode(DynamicLabel.label("Node"));
//        node.setProperty("id","1234");
//        ResourceIterable<Node> result = graphdb.findNodesByLabelAndProperty(DynamicLabel.label("Node"), "id", "1234");
//        long foundId = result.iterator().next().getId();
//        Assert.assertEquals(node.getId(), foundId);
//        tx.success();
//    }
