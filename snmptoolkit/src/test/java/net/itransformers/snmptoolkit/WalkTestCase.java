...
public class WalkTestCase {
    @Test
    public void testWalk() throws MibLoaderException, ParserConfigurationException, SAXException, XPathExpressionException, IOException {
        ...
        cmdOptions.put(CmdOptions.ADDRESS,"localhost/1161");
