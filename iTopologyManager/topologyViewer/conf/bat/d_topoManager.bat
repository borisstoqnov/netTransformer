...
java -classpath %CLASSPATH% net.itransformers.topologyviewer.gui.TopologyViewer -t directed -d network -g directed -f iTopologyManager\topologyViewer\conf\xml\directed.xml%*
