...
echo $CLASSPATH
echo $LIB
java -classpath ${CLASSPATH} net.itransformers.topologyviewer.gui.TopologyViewer -t undirected -d network -g undirected -f topology-viewer/conf/xml/undirected.xml $*
