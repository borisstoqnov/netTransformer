...
public class MyGraphMLReader {
     ...
     */
    public MyGraphMLReader(Graph graph) {
        this.graph = graph;
    }
    ...
    public void inputGraph(final InputStream graphMLInputStream) throws IOException {
        MyGraphMLReader.inputGraph(this.graph, graphMLInputStream, 1000, this.vertexIdKey, this.edgeIdKey, this.edgeLabelKey);
    }
    ...
    public void inputGraph(final String filename) throws IOException {
        MyGraphMLReader.inputGraph(this.graph, filename, 1000, this.vertexIdKey, this.edgeIdKey, this.edgeLabelKey);
    }
    ...
    public void inputGraph(final InputStream graphMLInputStream, int bufferSize) throws IOException {
        MyGraphMLReader.inputGraph(this.graph, graphMLInputStream, bufferSize, this.vertexIdKey, this.edgeIdKey, this.edgeLabelKey);
    }
    ...
    public void inputGraph(final String filename, int bufferSize) throws IOException {
        MyGraphMLReader.inputGraph(this.graph, filename, bufferSize, this.vertexIdKey, this.edgeIdKey, this.edgeLabelKey);
    }
    ...
    public static void inputGraph(final Graph inputGraph, final InputStream graphMLInputStream) throws IOException {
        MyGraphMLReader.inputGraph(inputGraph, graphMLInputStream, 1000, null, null, null);
    }
    ...
    public static void inputGraph(final Graph inputGraph, final String filename) throws IOException {
        MyGraphMLReader.inputGraph(inputGraph, filename, 1000, null, null, null);
    }
    ...
    public static void inputGraph(final Graph inputGraph, final String filename, int bufferSize, String vertexIdKey, String edgeIdKey, String edgeLabelKey) throws IOException {
        ...
        MyGraphMLReader.inputGraph(inputGraph, fis, bufferSize, vertexIdKey, edgeIdKey, edgeLabelKey);
        fis.close();
    }
