...
public class IntegrationTestMetroMAG123 {
    ...
    public void setUp() throws Exception {
        ...
        try {
           ...
           // params1.put("xslt","iDiscover/conf/xslt/transformator-undirected2.xslt");
            ...
            deviceLogger = new DeviceFileLogger(params1,new File(baseDir),"raw-data-metroE-MAG-123-0");
        ...
        resource = new Resource("MAG-123-0", "10.17.1.13", resourceParams);
        ...
        FileInputStream is = new FileInputStream("iDiscover/src/test/resources/raw-data-metroE/raw-data-MAG-123-0.xml");
        ...
        new NodeDiscoverer(){
            ...
            public NodeDiscoveryResult discover(ConnectionDetails connectionDetails) {
               ...
               // xmlTopologyDeviceLogger.handleDevice(result.getNodeId(),rawdata,discoveredDeviceData,resource);
                ...
                Assert.assertEquals(171,discoveredInterfaceCounter);
