...
public class IntegrationTestCiscoMPLSLabR3 {
    ...
    public void setUp() throws Exception {
        ...
        try {
           ...
           // params1.put("xslt","iDiscover/conf/xslt/transformator-undirected2.xslt");
            ...
            deviceLogger = new DeviceFileLogger(params1,new File(baseDir),"mpls-R3");
        ...
        FileInputStream is = new FileInputStream("iDiscover/src/test/resources/raw-data-mpls-lab/raw-data-R3.xml");
