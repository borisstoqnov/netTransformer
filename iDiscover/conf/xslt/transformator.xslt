...
<!--
  ...
  -->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:SnmpForXslt="net.itransformers.idiscover.discoveryhelpers.xml.SnmpForXslt" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:exslt="http://exslt.org/common" extension-element-prefixes="exslt" xmlns:functx="http://www.functx.com" xmlns:IPv6formatConvertor="net.itransformers.idiscover.util.IPv6formatConvertor" xmlns:InterfaceNeighbor="com.discovery.discoveryhelpers.xml.InterfaceNeighbor">
												...
												<parameter>
													...
													<value>
                                                         <xsl:variable name="devType">
                                                            <devtypes>
                                                            <xsl:for-each select="distinct-values($interface-neighbors/object[name=$name]/parameters/parameter[name='Neighbor Device Type']/value)">
                                                                <devtype><xsl:value-of select="."/></devtype>
                                                            </xsl:for-each>
                                                             </devtypes>
                                                        </xsl:variable>
                                                        <xsl:choose>
                                                            ...
                                                            <xsl:otherwise><xsl:value-of select="$devType/devtypes/devtype"/></xsl:otherwise>
                                                        </xsl:choose>
													</value>
												</parameter>
											</xsl:when>
